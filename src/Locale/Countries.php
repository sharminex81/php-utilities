 ...
 *
 * @author Shanrmin Shanta <shantaex81@gmail.com>
 * @url https://www.sharminshanta.com
 */

namespace SharminShanta\PHPUtilities\Locale;

/**
 * Class Countries
 * @package SharminShanta\PHPUtilities\Locale
 */
class Countries
{
    /**
     ...
     * @return string|null
     */
    public static function getFullName($countryCode)
    {
